...
//https://github.com/espressif/arduino-esp32/issues/6552#issuecomment-1092966533
 #define ATOMIC_BLOCK_START int _state = portSET_INTERRUPT_MASK_FROM_ISR();
 #define ATOMIC_BLOCK_END portCLEAR_INTERRUPT_MASK_FROM_ISR(_state);
#else 
 // TO BE DONE:
 #define ATOMIC_BLOCK_START
 #define ATOMIC_BLOCK_END
